...
import Opertaion from '../pages/History/Operation';
import Boarding from '../pages/History/Boarding';
  ...
  return (
    <Fragment>
      ...
      <Routes>
        ...
        <Route path="/member/operation" element={<Opertaion />} />
        <Route path="member/boarding" element={<Boarding />} />
