...
function useSearchPw(){
    ...
    return {
        isResetPw, inputValue, errorList, memberId, 
        navigate, goBackPage, handleInput, isValidSearchPwInput, 
        handleSearchSubmit, isValidResetPwInput, handleResetSubmit
    }
}

export default useSearchPw